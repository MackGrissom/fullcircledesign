...
<h1 className='md:text-6xl sm:text-5xl text-4xl font bold md:py-6 font font-bold text-black '>  </h1>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[#ffde59] uppercase font-bold shadow-md md:text-4x1 sm:text-3x1'> Web Design  </p>
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2'> Design </h1>
                    <p> Whether you're seeking a web-re-design, a make-over of your existing website, a mobile optimized version of your site, or a brand new site designed and developed from scratch; you can be confident that you are in good hands with our web design specialists. </p>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[#ffde59] uppercase font-bold shadow-md'> Web Development  </p>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[#ffde59] uppercase font-bold shadow-md'> SEO Optimization  </p>
