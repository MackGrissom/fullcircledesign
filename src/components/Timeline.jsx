        ...
        <ol class="relative border-l border-gray-200 dark:border-gray-700  max-w-full grid">
           ...
           {/* Step 1 - YOU */}
            ...
            <li class="mb-10 ml-6 bg-[white] bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg py-4 pl-4">
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white"> <span className='text-[#91ff00]'> WE </span> <br /> <br /> Provide you with a Site-map and Low-Fidelity Wireframe in Figma </h3>
