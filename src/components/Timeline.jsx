...
const Timeline = () => {
    return (
        ...
        <VerticalTimeline className='mt-4 -z-[1]'>
            ...
            <div className='x-auto text-center flex flex-col justify-center pt-[1%] items-center max-w-[1240px] bg-black bg-opacity-20 backdrop-blur-lg rounded-md drop-shadow-lg '> 
