...
const Timeline = () => {
    return (
        ...
        <ol class="relative border-l border-gray-200 dark:border-gray-700 mt-10 ml-5 max-w-[800px]">
...
{/* step 2 */}
            ...
            <li class="mb-10 ml-6">
                ...
                <h3 class="flex items-center mb-1 text-lg font-semibold text-gray-900 dark:text-white"> <span className='text-[#1F3A8A]'> WE </span> <br /> <br /> Provide you with a Sitemap and Low-Fidelity Wireframe in Figma </h3>
