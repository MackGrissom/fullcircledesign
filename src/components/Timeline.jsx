...
import BG2 from '../assets/bgsparkle.mp4'
    ...
    return (
        ...
        <VerticalTimeline className='mt-4 -z-[1]'>
            ...
            <VerticalTimelineElement
                className="vertical-timeline-element--work text-lg h-[50%]"
            ...
            <div className='x-auto text-center flex flex-col justify-center pt-[1%] items-center max-w-[1240px] bg-white bg-opacity-20 backdrop-blur-lg rounded-md drop-shadow-lg '> 
                ...
                <a href='contact'>  <button className='text-white  bg-[black] w-[200px] rounded-md font-medium my-6 py-3 mx-auto md:mx-0  hover:bg-white font-mono '> Contact Us </button> </a>
            </div>
