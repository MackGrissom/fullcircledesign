    ...
    return (
        <div className='bg-black  bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg'>
            ...
            <div className='mx-auto text-center flex flex-col justify-center pt-[1%] items-center max-w-[1240px]'>
                <h1 className='md:text-5xl sm:text-4xl text-4xl font bold md:py-0 text-[white] flex justify-center align-center   max-h-full max-w-[50%] object-cover h-[100px] mb-0 bg-gradient-to-r items-center -mt-[-44px]'> Services<div className='flex justify-between'>  </div>  </h1>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg  bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg'>
                ...
                <div className='flex flex-col justify-center  b'>
                    ...
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2 text-white'> We Optimize Websites to Drive Business Outcomes </h1>
