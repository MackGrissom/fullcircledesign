    ...
    return (
        <div className='bg-black  bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg'>
            ...
            <div className='mx-auto text-center flex flex-col justify-center pt-[1%] items-center max-w-[1240px]'>
                <h1 className=' lg:text-8xl md:text-5xl sm:text-4xl text-4xl font bold md:py-0 text-[white] flex justify-center align-center   max-h-full max-w-[50%] object-cover h-[100px] mb-0 bg-gradient-to-r items-center -mt-[-44px]'> Services<div className='flex justify-between'>  </div>  </h1>
                <p className='ml-5 text-[#ffde59] lg:text-[30px]  italic w-full text-center hidden lg:flex md:flex lg:justify-center md:justify-center'> What We Do & Why We're The Best Solution For your Business</p>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg mt-3  bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg mb-4'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[#ffde59] uppercase font-bold md:text-4x1 sm:text-3x1 ml-8 '> Web Design  </p>
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2 ml-8 text-white'> We're UI/UX Experts For Websites & Web Apps </h1>
                    <p className='ml-8 text-white'> Whether you're seeking a web-re-design, a make-over of your existing website, a mobile-friendly  version of your site, or a brand new site designed and developed from scratch; you can be confident that you are in good hands with our web design specialists. </p>
                    <p className='ml-8 text-[#ffde59]'>UX research, UI design, Wireframing & Prototyping  </p>

                    <button className='text-black  bg-[#ffde59] w-[200px] rounded-md font-medium my-6 py-3 mx-auto md:mx-0 hover:bg-white'> Get Started </button>
                </div>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg mt-3  bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg mb-4'>
                ...
                <div className='flex flex-col justify-center'>
                    <p className='text-[#ffde59] uppercase font-bold md:text-4x1 sm:text-3x1 ml-8'> Full-Stack Web Development  </p>
            ...
            <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg  bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg'>
                ...
                <div className='flex flex-col justify-center  b'>
                    <p className='text-[#ffde59] uppercase font-bold3 ml-8'> SEO Optimization  </p>
                    <h1 className='md:text-4xl sm:text-3xl text-2xl font-bold py-2 text-white ml-8'> We Optimize Websites to Drive Business Outcomes </h1>
                    ...
                    <p className='ml-4 text-[#ffde59] ml-8'> On-page SEO, Off-page SEO, Technical SEO</p>
                    <button className='text-black  bg-[#ffde59] w-[200px] rounded-md font-medium my-6 py-3 mx-auto md:mx-0 hover:bg-white'> Get Started </button>
