...
const Projects = () => {
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-md text-center lg:py-16 lg:px-12">
        ...
        <img src={Construction} alt='laptop' className='w-[200px] mx-auto my-4 ' />
        ...
        <p class="font-light text-gray-500 md:text-lg xl:text-xl dark:text-gray-400">Our Engineers are performing scheduled maintenance. Thanks for understanding </p>
    </div>
</section>
  )
}
