    ...
    <div className=''>
      <div className='mx-auto text-center flex flex-col justify-center pt-[1%] items-center max-w-[1240px] mt-4'>
        ...
        <div className='mx-auto text-center flex flex-col justify-center  items-center max-w-[1240px] '>
          <h1 className=' lg:text-8xl md:text-5xl sm:text-4xl text-4xl font bold md:py-0 text-[white] flex justify-center align-center   max-h-full max-w-[50%] object-cover h-[50px] bg-gradient-to-r items-center -mt-[-44px] font-mono bg-white  bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg mb-20'> About Us<div className='flex justify-between'>
          </div>  </h1>
          ...
          <p className='ml-5 text-[#ffde59] lg:text-[30px]  italic w-full text-center hidden lg:flex md:flex lg:justify-center md:justify-center font-mono bg-black  bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg'> A Quick Description Of Who We Are And What We Stand For </p>
        ...
        <div className='max-w-[1240px] mx-auto grid md:grid-cols-2 shadow-lg mt-3  bg-white bg-opacity-20 backdrop-blur-lg rounded drop-shadow-lg p-4 font-mono -z-[1]'>
          ...
          <div className='flex flex-col justify-center w-full'>
            <h1 className='md:text-3xl sm:text-2xl text-xl font-bold py-2 ml-8 text-[#ffde59] hover:text-white'> We are a team of &nbsp;

              <Typed strings={['Developers.', 'Designers.', 'Hackers.', 'Innovators.', 'Inventors.', 'Founders', 'Freelancers', "Future Thinkers"]} typeSpeed={100} backSpeed={50} loop className='text-l text-[white] font-bold  sm:text-1xl hover:bg-white hover:animate-bounce hover:text-[#ffde59] md:text-3xl sm:text-2xl  text-xl ' /> </h1>
            ...
            {/* <p className='ml-8 text-[#ffde59] mb-8 text-[15px] italic w-full'>
            ...
            <p className='bg-white bg-opacity-20 drop-shadow-lg backdrop-blur-lg rounded text-[#ffde59] p-4 italic font-bold mt-4'> Do you have skills in development, design or sales? <br />
              Come join the best team in the industry and help us build the future. </p>
            <a href='/contact'>  <button className='text-black  bg-[#ffde59] w-[200px] rounded-md font-medium my-6 py-3 mx-auto md:mx-0  hover:bg-white font-mono z-0'> Contact Us </button> </a>
