    ...
    return (
        <div className='text-black pt-h-14 main font-mono bg'>
            ...
            <div className='max-w-[900px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center content'>
                ...
                <br />
                <div>
                    <p className='md:text-2xl sm:text-1xl text-l font-bold bg-[black] backdrop-blur-lg rounded-md drop-shadow-lg p-3 text-[#ffde59] bg-opacity-20 font-mono'> We Design, Develop & Optimize Better Websites For &nbsp;
