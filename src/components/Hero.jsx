    ...
    return (
        <div className='text-black pt-h-14 main'>
            ...
            <div className='max-w-[900px] mt-[-96px] w-full h-screen mx-auto text-center flex flex-col justify-center content'>
                ...
                <h1 className='md:text-5xl sm:text-4xl text-3xl font bold md:py-6 bg-black bg-opacity-20 backdrop-blur-lg rounded-md drop-shadow-lg text-[white] -z-[1]'> Not All Websites Are Created Equal. </h1>
                <br />
                <div>
